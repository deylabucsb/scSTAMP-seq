...
%addpath('/Users/piscopio/Desktop/STAMP/Experiments/scMATseq/Run67/genome/Run71/MAT_FABA_ACCESS')
...
%% Load BackGroundPerGene

% Background Model based on H9 Open DNA (proteased) and Full GC
%load('Bulk_GC_2020_1_21_H9_Hypersensitivity_Top_Quartile_Per_Cell_25BP_Bin_plusMinus2000.mat')

% Background Model based on H9 Open DNA (proteased) and Full GC 
load('Bulk_GC_2022-07-19_HeLa_Hypersensitivity_TopQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat');

% Background Model based on Hela Open DNA (proteased) and Full GC % Run71
%load('Bulk_GC_HeLa_Hypersensitivity_TopQuartile_Per_Cell_25BP_Bin_PlusMinus3000.mat');

BulkBackGroundPerGene = CellGeneDistStruct;

% Load Genome WCG
%load('../WCG_Genome/Genome_WCG_2020_4_24_H9_Hypersensitivity_Top_Quartile_Per_Cell_25BP_Bin_plusMinus2000.mat')

% Load Genome WCG
load('Genome_WCG_2022-07-19_HeLa_Hypersensitivity_TopQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat');
%load('Genome_WCG_HeLa_Hypersensitivity_TopQuartile_Per_Cell_25BP_Bin_PlusMinus3000.mat'); % Run56_Run61_Run62 cat


GenomeWCGBackGroundPerGene = CellGeneDistStruct;


%% ACCESSIBILITY GC Run56_Run61 and cat_Run56_Run61_Run62

%---%
%Looking at Plate 39 Lib 3
%load('P39_Lib3_GC_2020_1_21_H9_Hypersenstivity_TopQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat')

%load('P4L1_ACCESS_GC_2022-07-19_HeLa_Hypersenstivity_BottomQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');

%load('R_Reformatted_Cluster_0_P4L1_ACCESS_GC_2022-07-19_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');
load('R_Reformatted_Cluster_1_P4L1_ACCESS_GC_2022-07-19_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');


%% ACCESSIBILIITY GC Run67_Run71

        %%%%% Cluster 0 %%%%%

%load('Run71_Cluster_0_P3L1_ACCESS_GC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L2_ACCESS_GC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L3_ACCESS_GC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L4_ACCESS_GC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');

%load('Test_Run71_Cluster_0_P3L1_ACCESS_GC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');

        %%%%% Cluster 1 %%%%%

%load('Run71_Cluster_1_P3L1_ACCESS_GC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L2_ACCESS_GC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L3_ACCESS_GC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L4_ACCESS_GC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
...
% load('P39_Lib4_GC_2020_1_21_H9_Hypersenstivity_TopQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat')
% 
...
%Looking at Plate 39 Lib 3
%load('P39_Lib3_WCG_2020_1_21_H9_Hypersenstivity_TopQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat');

%load('P4L1_ENDOG_WCG_2022-07-19_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');

%load('R_Reformatted_Cluster_0_P4L1_ENDOG_WCG_2022-07-19_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');
load('R_Reformatted_Cluster_1_P4L1_ENDOG_WCG_2022-07-19_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');

        %%%%% Cluster 0 %%%%%

%load('Run71_Cluster_0_P3L1_ENDOG_WCG_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L2_ENDOG_WCG_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L3_ENDOG_WCG_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L4_ENDOG_WCG_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');

%load('Test_Run71_Cluster_0_P3L1_ENDOG_WGC_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');


        %%%%% Cluster 1 %%%%%

%load('Run71_Cluster_1_P3L1_ENDOG_WCG_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L2_ENDOG_WCG_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L3_ENDOG_WCG_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L4_ENDOG_WCG_HeLa_Hypersenstivity_TopQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
...
% %---%
% %Looking at Plate 39 Lib 4
% load('P39_Lib4_WCG_2020_1_21_H9_Hypersenstivity_TopQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat')
% 
...
set(gca,'ycolor','b')
%title("HEK293T Hypersenstivity Sites")
title("HeLaHypersenstivity Sites")
legend(["Accessibility";"Endogenous"],'location','southoutside','orientation','horizontal')
box off
set(gcf,'color','w')
...
%%
%addpath('C:\Users\alexc\Box Sync\MATLAB')
...
title("HeLa DNaseI hypersensitivity site")
...
legend boxoff
text(1000,ymaxval-0.004,{"\bfUpper Quartile"},'FontName','Arial','FontSize',12,'HorizontalAlignment','center')



% print(gcf, 'H9_FreshCells_Normalized_ToBulk_Access_GC_and_Endogenous_WCG_Normalized_to_WCGGenome_H9_HypersensitvitySites_TopQuartile_25BpBin_1bin_BothSides_MoveAvg_RPM.png', '-dpng', '-r600', '-painters')
% saveas(gcf,'H9_FreshCells_Normalized_ToBulk_Access_GC_and_Endogenous_WCG_Normalized_to_WCGGenome_H9_HypersensitvitySites_TopQuartile_25BpBin_1bin_BothSides_MoveAvg_RPM.pdf')