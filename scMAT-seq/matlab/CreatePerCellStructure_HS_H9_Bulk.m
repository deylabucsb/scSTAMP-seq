...
%addpath('/Users/piscopio/Library/CloudStorage/Box-Box/scMATseq/HypersensitivityData/H9')
%addpath('/Users/piscopio/Library/CloudStorage/Box-Box/scMATseq/Exp02_(Run56_Run61)/Genomic/HypersensitivityData/H9')
addpath('/Users/piscopio/Library/CloudStorage/Box-Box/scMATseq/Exp_02/Run56_Run61_Run62/P4L1/Genomic/ReferenceData');
...
fileID= fopen('StrippedDNA_H9_GC_ACCESS_Bulk_dnaseI-HS_Bottom_quartile-3000-Upstream_3000-Downstream.txt');
SaveName='Bulk_GC_2022-07-19_HeLa_Hypersensitivity_BottomQuartile_Per_Cell_25BP_Bin_PlusMinus3000.mat';
%fileID= fopen('StrippedDNA_H9_GC_ACCESS_Bulk_dnaseI-HS_BottomMiddle_quartile-3000-Upstream_3000-Downstream.txt');
%SaveName='Bulk_GC_2022-07-19_HeLa_Hypersensitivity_MiddleBottomQuartile_Per_Cell_25BP_Bin__PlusMinus3000.mat';
%fileID= fopen('StrippedDNA_H9_GC_ACCESS_Bulk_dnaseI-HS_TopMiddle_quartile-3000-Upstream_3000-Downstream.txt');
%SaveName='Bulk_GC_2022-07-19_HeLa_Hypersensitivity_MiddleTopQuartile_Per_Cell_25BP_Bin__PlusMinus3000.mat';
%fileID= fopen('StrippedDNA_H9_GC_ACCESS_Bulk_dnaseI-HS_Top_quartile-3000-Upstream_3000-Downstream.txt');
%SaveName='Bulk_GC_2022-07-19_HeLa_Hypersensitivity_TopQuartile_Per_Cell_25BP_Bin__PlusMinus3000.mat';
...
%fileID= fopen('StrippedDNA_H9_GC_ACCESS_Bulk_AllData_H9Hypersenstivity_BottomQuartile-2000-Upstream_2000-Downstream.txt');
%SaveName='Bulk_GC_2020_1_19_H9_Hypersensitivity_Bottom_Quartile_Per_Cell_25BP_Bin__PlusMinus3000.mat';
