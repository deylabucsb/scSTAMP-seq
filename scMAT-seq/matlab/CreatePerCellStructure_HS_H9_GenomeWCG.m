...
% load('..\H9\wgEncodeAwgDnaseDukeH9esUniPk_Reformated_TopQuartile.mat');
...
%fileID= fopen('WCG_hg19_reformatted_dnaseI-HS_Bottom_quartile-3000-Upstream_3000-Downstream.txt');
%SaveName='Genome_WCG_2022-07-19_HeLa_Hypersensitivity_BottomQuartile_Per_Cell_25BP_Bin__PlusMinus3000.mat';
%fileID= fopen('WCG_hg19_reformatted_dnaseI-HS_BottomMiddle_quartile-3000-Upstream_3000-Downstream.txt');
%SaveName='Genome_WCG_2022-07-19_HeLa_Hypersensitivity_MiddleBottomQuartile_Per_Cell_25BP_Bin__PlusMinus3000.mat';
%fileID= fopen('WCG_hg19_reformatted_dnaseI-HS_TopMiddle_quartile-3000-Upstream_3000-Downstream.txt');
%SaveName='Genome_WCG_2022-07-19_HeLa_Hypersensitivity_MiddleTopQuartile_Per_Cell_25BP_Bin__PlusMinus3000.mat';
fileID= fopen('WCG_hg19_reformatted_dnaseI-HS_Top_quartile-3000-Upstream_3000-Downstream.txt');
SaveName='Genome_WCG_2022-07-19_HeLa_Hypersensitivity_TopQuartile_Per_Cell_25BP_Bin__PlusMinus3000.mat';
...
% fileID= fopen('WCG_hg19_H9DNAseITopQuartile-2000-Upstream_2000-Downstream.txt');
% SaveName='Genome_WCG_2020_4_24_H9_Hypersensitivity_Top_Quartile_Per_Cell_25BP_Bin__PlusMinus3000.mat';




%C = textscan(fileID,'%s %s %f','HeaderLines',0);
C = textscan(fileID,'%f %s %f %s %f','HeaderLines',0);
fclose(fileID);

SingleCellChr = C{1,2};
SingleCellLoci = C{1,3};
SingleCellCell= ones(length(C{1,3}),1);
SingleCellStrand= ones(length(C{1,3}),1);
