...
%fileID= fopen('Hela-MSPJI-se_Full5mC_Endogenous_WCG_Final_Rmdup_dnaseI-HS_BottomQuartile-3000-Upstream_3000-Downstream.txt');
%SaveName='Genome_WCG_HeLa_Hypersensitivity_BottomQuartile_Per_Cell_25BP_Bin_PlusMinus3000.mat';
%fileID= fopen('Hela-MSPJI-se_Full5mC_Endogenous_WCG_Final_Rmdup_dnaseI-HS_MidBotQuartile-3000-Upstream_3000-Downstream.txt');
%SaveName='Genome_WCG_HeLa_Hypersensitivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_PlusMinus3000.mat';
%fileID= fopen('Hela-MSPJI-se_Full5mC_Endogenous_WCG_Final_Rmdup_dnaseI-HS_MidTopQuartile-3000-Upstream_3000-Downstream.txt');
%SaveName='Genome_WCG_HeLa_Hypersensitivity_MiddleTopQuartile_Per_Cell_25BP_Bin_PlusMinus3000.mat';
fileID= fopen('Hela-MSPJI-se_Full5mC_Endogenous_WCG_Final_Rmdup_dnaseI-HS_TopQuartile-3000-Upstream_3000-Downstream.txt');
SaveName='Genome_WCG_HeLa_Hypersensitivity_TopQuartile_Per_Cell_25BP_Bin_PlusMinus3000.mat';
