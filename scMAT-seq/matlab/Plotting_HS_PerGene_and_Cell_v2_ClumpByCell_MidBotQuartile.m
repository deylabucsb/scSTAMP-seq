...
%load('Bulk_GC_2020_1_21_H9_Hypersensitivity_MiddleBottom_Quartile_Per_Cell_25BP_Bin_plusMinus2000.mat')


%Background Model based on H9 Open DNA (proteased) and Full GC
%load('Bulk_GC_2022-07-19_HeLa_Hypersensitivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat');

%Background Model based on Hela Open DNA (proteased) and Full GC
%load('Bulk_GC_HeLa_Hypersensitivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_PlusMinus3000.mat');
load('Bulk_GC_2022-07-19_HeLa_Hypersensitivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat');
...
%Load Genome WCG
%load('../WCG_Genome/Genome_WCG_2020_4_24_H9_Hypersensitivity_MiddleBottom_Quartile_Per_Cell_25BP_Bin_plusMinus2000.mat')

%Load Genome WCG
load('Genome_WCG_2022-07-19_HeLa_Hypersensitivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat');
%load('Genome_WCG_HeLa_Hypersensitivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_PlusMinus3000.mat');
...
%load('P39_Lib3_GC_2020_1_21_H9_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat')

%load('P4L1_ACCESS_GC_2022-07-19_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');

%load('R_Reformatted_Cluster_0_P4L1_ACCESS_GC_2022-07-19_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');
load('R_Reformatted_Cluster_1_P4L1_ACCESS_GC_2022-07-19_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');

%% ACCESSIBILITY GC

        %%%%% Cluster 0 %%%%%

%load('Run71_Cluster_0_P3L1_ACCESS_GC_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L2_ACCESS_GC_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L3_ACCESS_GC_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L4_ACCESS_GC_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');

        %%%%% Cluster 1 %%%%%

%load('Run71_Cluster_1_P3L1_ACCESS_GC_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L2_ACCESS_GC_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L3_ACCESS_GC_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L4_ACCESS_GC_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
...
% load('P39_Lib4_GC_2020_1_21_H9_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat')
% 
...
%Looking at Plate 39 Lib 3
%load('P39_Lib3_WCG_2020_1_21_H9_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat')

%load('P4L1_ENDOG_WCG_2022-07-19_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat')

%load('R_Reformatted_Cluster_0_P4L1_ENDOG_WCG_2022-07-19_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');
load('R_Reformatted_Cluster_1_P4L1_ENDOG_WCG_2022-07-19_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_plusMinus2000.mat');

        %%%%% Cluster 0 %%%%%

%load('Run71_Cluster_0_P3L1_ENDOG_WCG_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L2_ENDOG_WCG_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L3_ENDOG_WCG_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_0_P3L4_ENDOG_WCG_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');

        %%%%% Cluster 1 %%%%%

%load('Run71_Cluster_1_P3L1_ENDOG_WCG_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L2_ENDOG_WCG_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L3_ENDOG_WCG_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
%load('Run71_Cluster_1_P3L4_ENDOG_WCG_HeLa_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP-Bin_PlusMinus3000.mat');
...
% %---%
% %Looking at Plate 39 Lib 4
% load('P39_Lib4_WCG_2020_1_21_H9_Hypersenstivity_MiddleBottomQuartile_Per_Cell_25BP_Bin_plusMinus2000.mat')
% 
...
legend boxoff
text(1000,ymaxval-0.004,{"\bfSecond Quartile"},'FontName','Arial','FontSize',12,'HorizontalAlignment','center')

% print(gcf, 'H9_FreshCells_Normalized_ToBulk_Access_GC_and_Endogenous_WCG_Normalized_to_WCGGenome_H9_HypersensitvitySites_MiddleBottomQuartile_25BpBin_1bin_BothSides_MoveAvg_RPM.png', '-dpng', '-r600', '-painters')
% saveas(gcf,'H9_FreshCells_Normalized_ToBulk_Access_GC_and_Endogenous_WCG_Normalized_to_WCGGenome_H9_HypersensitvitySites_MiddleBottomQuartile_25BpBin_1bin_BothSides_MoveAvg_RPM.pdf')